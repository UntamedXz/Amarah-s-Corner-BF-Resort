...
<body>
    ...
    <script>
        ...
        function display_seconds() {
            seconds -= 1;
            document.getElementById('seconds_display').innerText='This page will be redirected to login page in '+seconds+' seconds...';
        }
        setInterval(display_seconds, 1000);

        function redirect_page() {
            window.location="http://localhost/theserve-amarah-s-corner-bf-resort/login";
        }
