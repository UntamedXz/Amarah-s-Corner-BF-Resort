...
if(isset($_POST['password_reset'])) {
    ...
    if(mysqli_num_rows($get_info) > 0) {
        ...
        <a style='background-color: #ffaf08; padding: 5px 10px; text-decoration: none; text-transform: uppercase; color: #070506; font-weight: 700;' href='http://localhost/theserve-amarah-s-corner-las-pinas/password-change?vkey=$vkey&email=$get_email'>Reset Password</a>";
