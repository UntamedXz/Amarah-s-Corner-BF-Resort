        ...
        <section class="insert-products">
            <form id="insert_product" action="" enctype="multipart/form-data">
                <div class="left_group">
                    <input type="text" name="product_id" id="product_id" value="<?php if(isset($product_id)) { echo $product_id; } ?>">
                                    ...
                                    <?php
                                        if(isset($product_id)) {
                                            ...
                                            foreach($get_attributes as $attributes) {
                                                ...
                                                $count++;
                                                ?>
                                                <input type="text" name="attribute_id[]" id="attribute_id" value="<?php echo $attributes['attribute_id'] ?>">
