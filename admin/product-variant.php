    ...
    <main>
        ...
        <script>
            ...
            $(document).on('click', '#getEdit', function(e) {
                ...
                $.ajax({
                    url: './functions/crud/product-variant',
                    type: 'POST',
        ...
        <script>
            ...
            $(document).ready(function() {
                $("#edit-variant").on('submit', function(e) {
                    ...
                    form.append('update_product_variant', true);
                    $.ajax({
                        type: "POST",
                        url: "./functions/crud/product-variant",
                        data: form,
                ...
                $('#insert-variant').on('submit', function(e) {
                    e.preventDefault();
                    var form = new FormData(this);
                    form.append('insert_product_variant', true);
                    $.ajax({
                        type: "POST",
                        url: "./functions/crud/product-variant",
                        data: form,
                ...
                $("#delete_variant").on('submit', function(e) {
                    e.preventDefault();
                    var form = new FormData(this);
                    form.append('delete_product_variant', true);
                    $.ajax({
                        type: "POST",
                        url: "./functions/crud/product-variant",
                        data: form,
