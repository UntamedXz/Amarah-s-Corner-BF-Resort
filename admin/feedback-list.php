...
<body>
    ...
    <main>
        ...
        <ul class="breadcrumbs">
            ...
            <li class="divider">/</li>
            <li><a href="view-category" class="active">View Customer's Feedback</a></li>
        </ul>
        ...
        <div class="wrapper">
            <table class="full">
                ...
                <tbody>
                    <tr>
                        <td>Masarap grabe! oorder ako ulit.</td>
                        <td>kbillones95@gmail.com</td>
                        <td>
                        ...
                        <td> <button type="button" class="btn btn-primary"><i class="fa fa-eye"></td>
                </tbody>
            </table>
        </div>
        </section>
